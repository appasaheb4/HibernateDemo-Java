...
Date currentDate;
int xcenter = 80, ycenter = 100, lastxs = 0, lastys = 0, lastxm = 0, lastym = 0, lastxh = 0,lastyh = 0;
private void drawStructure(Graphics g){
g.setFont(new Font("TimesRoman", Font.BOLD, 14));
g.setColor(Color.black);
g.fillOval(xcenter - 200, ycenter -200 , 500, 1000);
g.setColor(Color.YELLOW);
g.drawString("BANK SYSTEM" ,25,150);
g.setColor(Color.white);
g.drawString("9", xcenter - 76, ycenter +0);
g.drawString("3", xcenter + 72, ycenter + 0);
g.drawString("12", xcenter - 5, ycenter - 85);
g.drawString("6", xcenter - 5, ycenter + 81);
}
